...
- [Prisma starter kit](https://github.com/fivethree-team/nestjs-prisma-starter)
...
Add .env file in your project root (MySQL example):
...
DB_URL=YOUR_URL
DB_PORT=YOUR_PORT
DATABASE_URL="${DB_PROVIDER}://${DB_USER}:${DB_PASSWORD}@${DB_URL}:${DB_PORT}/${DB_DB}"
